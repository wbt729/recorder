...
**
** Created: Mon 27. Feb 14:13:53 2012
...
static const char qt_meta_stringdata_Recorder[] = {
    "Recorder\0\0doThings()\0onLabelMouseWheel(int)\0"
    "onNewImage()\0onError(int)\0"
};
...
void Recorder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->doThings(); break;
        case 1: _t->onLabelMouseWheel((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->onNewImage(); break;
        case 3: _t->onError((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
